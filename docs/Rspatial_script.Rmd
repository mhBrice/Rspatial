...
- name: Marie-Hélène Brice
  affiliation: PhD student in ecology at Université de Montréal, Quebec Center for Biodiversity Science (QCBS)
output:
  html_document:
...
<p>
<img src="https://www.geoimage.com.au/images/Galleries/Spot1-4/spot_20mmulti_nr2_1000.jpg" style="float:left;width:250px;margin: 0px 20px">
...
```{r plot_crop2, echo=T, message = F, fig.align="center", fig.height=4}
...
```{r mapview31, echo=F}
myPal <- colorRampPalette(brewer.pal(9, "YlGnBu"))
mapview(ruisso_env, zcol = "resid", cex = "Temperature", legend = TRUE, col.regions = myPal,
        layer.name = "% of public building")
```
</div>
